...
def inventory_ordering_policy(row, month_columns):
    ...
    for i, demand in enumerate(monthly_demands):
        # Record inventory level at start of month (before ordering)
        start_month_inventory = current_inventory
        ...
        # Record end-of-month inventory level (after ordering and demand consumption)
        monthly_inventory_levels.append(current_inventory)
    ...
    for idx, row in df.iterrows():
        ...
        for i, month in enumerate(month_columns):
            ...
            if i < len(monthly_orders):
                ...
                output_df.loc[idx, order_col_name] = 0
                output_df.loc[idx, inventory_col_name] = 0
...
if __name__ == "__main__":
    ...
    output_file = "C:/Users/I3Nexus/Desktop/ordering_recommendations_V1.xlsx"
