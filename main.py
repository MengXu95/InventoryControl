...
import MTGP_niching_replenish_transship.GPFC as GPmain_niching_replenish_transship
import MTGP_niching_replenish_transship.testRuleMTGP as InventoryGPReplenishTransshipTest
...
import LLM_policy_evolution.mutation_loop as LLM_policy_mutation_loop
...
def print_usage():
    ...
    print("Common algos: MTGP_niching, CCGP_niching, InventoryGP, MTGP_niching_replenish_transship, LLM_policy_evolution, LLM_policy_evolution_next")
...
if __name__ == '__main__':
    ...
    elif algo == 'MTGP_niching_replenish_transship':
        print('----------MTGP_niching_replenish_transship----------')
        GPmain_niching_replenish_transship.main(dataset_name, seed)
    ...
    elif algo == 'LLM_policy_evolution_next':
        print('----------LLM_policy_evolution_next----------')
        LLM_policy_mutation_loop.main(dataset_name, seed)
