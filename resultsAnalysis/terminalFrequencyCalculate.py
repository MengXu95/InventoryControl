...
def plot_scenarios(algo, scenarios):
    num_scenarios = len(scenarios)
    cols = 2  # Two columns: one for replenishment and one for transshipment
    ...
    plot_file_path = os.path.join(plot_dir, 'mean_node_counts.png')
