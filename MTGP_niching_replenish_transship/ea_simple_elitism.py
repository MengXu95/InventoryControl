...
from MTGP_niching_replenish_transship.BroodRecombination.broodRecombination import broodPop
from MTGP_niching_replenish_transship.selection import selElitistAndTournament
from Utils.FitnessDiversity import FitnessDiversityCalculator
# from MTGP_niching_replenish_transship.niching.niching import niching_clear
from MTGP_niching_replenish_transship.fitnessNiching import niching_clear
...
def eaSimple(randomSeed_ngen, population, toolbox, cxpb, mutpb, reppb, elitism, ngen, seedRotate, use_niching, USE_BroodRecombination, Check_policy_valid, rd, stats=None,halloffame=None, verbose=__debug__, seed = __debug__, dataset_name=__debug__):
    ...
    scenarioDesign = ScenarioDesign_replenish_transship(dataset_name)
