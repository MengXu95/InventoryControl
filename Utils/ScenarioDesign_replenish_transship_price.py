...
class ScenarioDesign_replenish_transship_price():
    def __init__(self, scenario):
        """
        Initialize the scenario design for replenishment, transshipment, and RFQ price prediction.
    ...
    def get_parameter(self, seed=0):
        ...
        if self.scenario == "teckwah_training":
            ...
            demand_level = 30000
            RFQ_deadline_level = demand_level / 3
            num_retailer = 2
            ...
            return {
                ...
                'RFQ_deadline_level': RFQ_deadline_level,
                'epi_len': epi_len,
            ...
            per_unit_order = [1] * num_retailer  # Per unit order costs
            per_trans_item = 1  # Per unit cost for transshipment (either direction)
            per_trans_order = 10  # Fixed cost per transshipment (either direction)
            partial_information_visibility = True
    ...
    def get_parameter_S2Demo(self, seed=0, epi_len=64):
        ...
        if self.scenario == "teckwah_training":
            ...
            LT = 2
            demand_level = None
            RFQ_deadline_level = 30000 / 3  # Use default value when demand_level is None
            # epi_len = 64  # Length of one episode (default)
            num_retailer = 2
            ini_inv = [500] * 2  # Initial inventory levels
            holding = [2, 10]  # Holding costs
...
if __name__ == '__main__':
    ...
    scenarioDesign = ScenarioDesign_replenish_transship_price(scenario)
    parameters = scenarioDesign.get_parameter()
    print("Teckwah Training Parameters:")
    print(parameters)
    print()
    ...
    print("Teckwah Test Parameters (seed=6):")
    print(parameters)
    print()
    ...
    scenarioDesign = ScenarioDesign_replenish_transship_price(scenario)
    parameters = scenarioDesign.get_parameter()
    print("Small 2 Retailers Parameters:")
    print(parameters)
    print()
    ...
    scenarioDesign = ScenarioDesign_replenish_transship_price(scenario)
    parameters = scenarioDesign.get_parameter()
    print("Medium 3 Retailers Parameters:")
    print(parameters)