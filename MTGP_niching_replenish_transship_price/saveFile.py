...
def save_individual(randomSeeds, dataSetName,individuals):
    ...
    directory = f'./MTGP_niching_replenish_transship_price/train/scenario_{dataSetName}/'
...
def save_TestResults_to_csv(randomSeeds, dataSetName, resultsDf):
    ...
    # Construct the directory and file path
    directory = f'./MTGP_niching_replenish_transship_price/train/scenario_{dataSetName}/test/'
