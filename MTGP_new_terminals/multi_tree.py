...
def init_primitives(pset):
    ...
    pset.addTerminal(str('INL'))  # add by mengxu for 2 sites
    pset.addTerminal(str('FC1'))  # add by mengxu
    pset.addTerminal(str('FC2'))  # add by mengxu
    pset.addTerminal(str('PIP'))  # add by mengxu for example L = 2
    pset.addTerminal(str('HC'))  # add by mengxu
    pset.addTerminal(str('PLSC'))  # add by mengxu
    pset.addTerminal(str('FOC'))  # add by mengxu for example L = 2
